...
export default function InventoryStatCards({ refreshTrigger }: InventoryStatCardsProps) {
        ...
        <CardContent className="p-4 flex items-center">
          ...
          <div>
            ...
            <p className="text-xs text-green-600 dark:text-green-400">
              Items left: {summary.highest_quantity?.quantity || 0}
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-4 flex items-center">
          ...
          <div>
            ...
            <p className="text-xs text-amber-600 dark:text-amber-400">
              Items left: {summary.lowest_quantity?.quantity || 0}
            </p>
          </div>
        </CardContent>
      </Card>
